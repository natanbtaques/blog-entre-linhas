                ...
                <div className="container mx-auto px-6 sm:px-12 md:px-24 bg-white rounded-lg shadow-lg max-w-3xl">
                    ...
                    <div>{/* Botões de Ação */}
                        <div className="flex justify-center mt-8 space-x-4 mb-10">
                            <a
                                href="/posts"
                                className=" color-1 text-white px-6 py-3 rounded-full text-lg font-semibold"
                            >
                                Back to posts
                            </a>
                            <button
                                ...
                                className=" color-2 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-color-pur-to-red  "
                            >
                                Delete Post
                            </button>
                        </div>
